...
- 002-peer-evaluation: 新增評量考核系統。Firestore 集合：`evaluationCycles`, `evaluationAssignments`, `evaluationForms`, `userAttributeSnapshots`。Z-score 防灌水校正（前端計算），純 SVG 雷達圖與趨勢圖，整體評語/具體回饋滾動區，RO 職業原型判定。
