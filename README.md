...
2. **評核者填寫匿名考評表（10 題評分 + 整體評價）**：系統開放評核者填寫 10 道職場行為題目（每題 1–10 分），並於表末填寫整體評語（20–500 字）。分數 ≥9 或 ≤3 時，回饋說明欄自動轉為必填。
...
| 屬性代號 | 中文名稱 | 說明 |
|---------|---------|------|
| EXE | 執行力 | 任務推進、持續完成與達成目標的能力 |
| INS | 洞察力 | 問題診斷、需求分析與情境判讀的能力 |
| ADP | 應變力 | 面對變化、快速調整與跨情境適應的能力 |
| COL | 協作力 | 團隊合作、溝通協調與關係建立的能力 |
| STB | 穩定力 | 壓力承受、情緒管理與一致性表現的能力 |
| INN | 創新力 | 提出新想法、主動改善與突破常規的能力 |
