...
5. **受評者查看屬性報告（雷達圖、職業原型、跑馬燈）**：受評者登入後可在「我的屬性報告」頁面查看六角雷達圖、職業原型標籤、匿名整體評語跑馬燈，以及跨週期成長趨勢折線圖。

### 角色說明

| 角色 | 職責 |
|------|------|
| **管理者**（role: admin） | 建立與管理考核週期、指派評核關係、查閱所有考評表（含評核者身份）、執行結束並發布、開啟排名視圖、重算職業原型（全週期或單一受評者） |
